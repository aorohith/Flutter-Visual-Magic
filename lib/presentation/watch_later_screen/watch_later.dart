...
class WatchLater extends StatefulWidget {
  ...
  @override
  State<WatchLater> createState() => _WatchlaterListState();
}

class _WatchlaterListState extends State<WatchLater> {
  @override
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: const Text(
                              "Do you wants to clear Watchlater Videos?"),
                          actions: [
                            ElevatedButton(
        ...
        child: Padding(
          ...
          child: AnimationLimiter(
            child: ValueListenableBuilder(
              ...
              builder: (BuildContext ctx, Box<WatchlaterModel> watchlaterList,
                  Widget? child) {
                return watchlaterList.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          WatchlaterModel? watchlater =
                              watchlaterList.getAt(index);
                          return Container(
